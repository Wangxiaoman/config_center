...
public class MD5 {
	...
	private static final String SALT = "~!@#$ehome_audit%)c8";
	...
	public static String getMD5CodeWithSalt(String strObj) {
		...
		try {
		    ...
		    logger.error("get md5 code with default salt error",ex);
		}
		return resultString;
	}
	...
	public static String getMD5CodeWithSalt(String strObj,String salt) {
        ...
        try {
            ...
            logger.error("get md5 code with salt error",ex);
        }
        return resultString;
    }
	...
	public static String getMD5Code(String strObj) {
		...
		try {
		    ...
		    logger.error("get md5 code error",ex);
		}
		return resultString;
	}
	
//	public static void main(String[] args) {
//        System.out.println(getMD5Code("868064024228840"));
//    }
}
